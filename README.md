...
## Building MatBuilder
 ...
 you first need to verify the paths to the CPLEX headers and libraries (cf [CMakeLists.txt](https://github.com/loispaulin/matbuilder/blob/6b8474f16bfc26d2c82fcaf6bf55e544db6706e1/CMakeLists.txt#L25-L35)).
